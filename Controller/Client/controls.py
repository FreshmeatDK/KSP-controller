...
def actions(ctrl, oldCtrl, vessel, partlist, conn):
    ...
    if ((ctrl[1] & 0b00000010) !=(oldCtrl[1] & 0b00000010) and (ctrl[1] & 0b00000010)==0b00000010): # Deploy parachutes
        for Parachute in vessel.parts.parachutes:
            Parachute.deploy()

    if ((ctrl[1] & 0b00000100) !=(oldCtrl[1] & 0b00000100) and (ctrl[1] & 0b00000100)==0b00000100): # Run repeatable science experiments
        DoneExperimentList = []
    ...
    if ((ctrl[1] & 0b00001000) !=(oldCtrl[1] & 0b00001000) and (ctrl[1] & 0b00001000)==0b00001000): # Run all science experiments
        DoneExperimentList = []
        for Experiment in vessel.parts.experiments:
